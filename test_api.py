...
def use_coupon_of_same_value():
    ...
    print("user 1 uses get_coupon API",response_1.json())
    print("-----------------------------------")
    response_2 = requests.get(DOMAIN_URL+'coupons/1')
    print("user 1 uses get_coupon API",response_2.json())
    print("-----------------------------------")
...
if __name__ == '__main__':
    ...
    # print("This demonstrates consistency between globally acessible databases  and coponns created in france can immediately be accessed in ireland etc.")
